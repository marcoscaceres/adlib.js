...
window.define(function (require) {
    ...
    var exporter = require('webIDL/InterfaceExporter'),
        MIDIEvent = require('interfaces/MIDIEvent'),
        MIDIPort = require('interfaces/MIDIPort'),
    ...
    function EventManager() {
        ...
        function registerObject(obj) {
            ...
            constainer.dispatcher.listeners = [];
            register.push(constainer);
            return constainer.dispatcher;
        }
